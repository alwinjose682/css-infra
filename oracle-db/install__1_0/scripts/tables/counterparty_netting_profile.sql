...
ALTER TABLE counterparty_netting_profile ADD CONSTRAINT cpnp_pk PRIMARY KEY(netting_profile_id, netting_profile_version) USING INDEX tablespace &INDEX_TS;
...
--CREATE INDEX cpnp_cp_pt_idx on counterparty_netting_profile(counterparty_code, counterparty_version, product) tablespace &INDEX_TS;
